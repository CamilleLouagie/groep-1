...
\begin{frame}
	...
	\begin{figure}
		...
		%kaart van vlaanderen waarin rood= ruimtebeslag > drempelwaarde
	...
	%we focussen ons in deze presentatie op de mobiliteitsproblemen
\end{itemize}
...
\begin{frame}{{\Large Wegen de voordelen van zelfrijdende auto's op tegen de nadelen?}}
	%zelfrijdende auto's als onderdeel van een slimme stad
	\begin{columns}
